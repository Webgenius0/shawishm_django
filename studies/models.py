...
class Studies(models.Model):
    ...
    pat_inc_id_det = models.ForeignKey(Patients, models.DO_NOTHING, db_column='Pat_inc_id_det', blank=True, null=True , related_name='pat_inc_id_det')  # Field name made lowercase.
